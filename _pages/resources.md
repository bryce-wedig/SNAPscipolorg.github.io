...
If you have information that you believe should be included on this page, please reach out to us at [snapscipolorg@gmail.com](mailto:snapscipolorg@gmail.com). We'd be thrilled to add it!
...
We recommend checking out the [Civic Science Career Roadmap](https://civic-science-f.nyc3.digitaloceanspaces.com/app/uploads/2023/10/Civic-Science-Career-Roadmap.pdf) to help you navigate the various roles and opportunities available within the field(s)!

#### Science-Policy Fellowship & Job Information

- S&T Impact's [dashboard](https://www.scitechimpact.org/dashboard) for "active and developing science and technology policy fellowships," which they try to keep frequently updated
- [Database](https://scipolprograms.org/program-database/) on science policy programs
- [Information](https://emergingtechpolicy.org/pathways/policy-fellowships/) on fellowships, guides, and links to databases such as [this one](https://airtable.com/app3AlIYjrAVYhvIe/shr1dGfy6WQfJ5mei/tblD3ExDW2P8mtVlj) on active fellowships
- S&T Policy Job Openings [newsletter](https://www.linkedin.com/newsletters/s-t-policy-job-openings-7204924581470482433/) by Dr. Deborah Stine
- The [job board](https://jobs.sciencecareers.org/) from Science Careers can be filtered by discipline, or with keywords

#### Workshops and internships/externships are a great way to get some experience.

SNAPpers have attended AAAS' [Catalyzing Advocacy in Science and Engineering Workshop](https://www.aaas.org/programs/catalyzing-advocacy-in-science-and-engineering) and the [Advocacy Training Program](https://www.asbmb.org/advocacy/advocacy-training-program) by the American Society for Biochemistry and Molecular Biology.
...
- [S&T Impact Advisory Group](https://www.scitechimpact.org/)
...
- [The Institute of Science & Policy](https://institute.dmns.org/)
- [Missouri Science and Technology Policy Initiative](https://mostpolicyinitiative.org/)
- [Science for Georgia](https://scienceforgeorgia.org/)
